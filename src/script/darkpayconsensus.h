...
#ifndef DARKPAY_SCRIPT_DARKPAYCONSENSUS_H
#define DARKPAY_SCRIPT_DARKPAYCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBDARKPAYCONSENSUS)
...
#endif // DARKPAY_SCRIPT_DARKPAYCONSENSUS_H
