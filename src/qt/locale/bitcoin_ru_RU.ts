...
<context>
    ...
    <message>
        ...
        <translation>Это ваши Darkpay адреса для отправки платежа. Всегда проверяйте сумму и адрес получателя перед отправкой платежа.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши Darkpay адреса для получения платежей. Настоятельно рекомендуем использовать новые адреса для получения каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подписывайте сообщения Darkpay адресами чтобы подтвердить что это написали именно Вы</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Darkpay addresses</source>
        <translation>Проверяйте сообщения чтобы убедиться что они подписаны конкретными Darkpay адресами</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Darkpay</numerusform><numerusform>%n активных подключения к сети Darkpay</numerusform><numerusform>%n активных подключений к сети Darkpay</numerusform><numerusform>%n активных подключений к сети Darkpay</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Darkpay больше не может продолжать безопасную работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным адресом Darkpay.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Darkpay-клиента на маршрутизаторе. Работает только если Ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключится к сети Darkpay через SOCKS5 прокси.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Darkpay после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить darkpay: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'darkpay://' не верный URI. Используйте 'darkpay:' вместо этого.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать идентификатор! Это может быть связано с неверным Darkpay-адресом или неправильными параметрами идентификатора.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Darkpay.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Предупреждение: Неверный Darkpay адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Darkpay-адрес, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Сообщение прикрепленное к darkpay идентификатору будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Darkpay.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Darkpay-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать предыдущий использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение Darkpay-адресом</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Darkpay-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Darkpay address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным Darkpay-адресом</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
