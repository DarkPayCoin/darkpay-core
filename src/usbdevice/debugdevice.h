// Copyright (c) 2018-2019 The Darkpay Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DARKPAY_USBDEVICE_DEBUGDEVICE_H
#define DARKPAY_USBDEVICE_DEBUGDEVICE_H
...
#endif // DARKPAY_USBDEVICE_DEBUGDEVICE_H
